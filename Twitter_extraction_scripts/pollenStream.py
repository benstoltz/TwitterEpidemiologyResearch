...
query = 'pollen,polen,pollon,pollan,pollin,allergies,allergy,allergys'
    ...
    try:
        ...
        try:
            if response['geo']:
                ...
                save_to_mongo(tweet, 'pollenStreamDatabase', 'geolocated')
            else:
                save_to_mongo(tweet, 'pollenStreamDatabase', 'tweets')
        except KeyError:
            print tweet
            pass
